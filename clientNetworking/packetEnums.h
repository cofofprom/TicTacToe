...
enum servicePacketType {ServicePingRequest = 1, ServicePingResponse = 2, ServiceErrorPacket = 3, ServiceSuccess = 4,
        ServiceUserAction = 5, ServiceEndGame = 6, ServiceNotificationPacket = 7};
...
enum userActionsEnum {GameRequestAction = 1, BlacklistAction = 2, FriendRequestAction = 3,
    ...
    GameAcceptAction = 10, GameDeclineAction = 11, DisconnectAction = 12};
